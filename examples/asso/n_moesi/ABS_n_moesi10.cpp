/******************************
  Program "../examples/asso/n_moesi/ABS_n_moesi10.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "../examples/asso/n_moesi/ABS_n_moesi10"
...
/********************
  Invariant records
 ********************/
int mu__invariant_11() // Invariant "rule_4"
{
bool mu__quant12; 
mu__quant12 = TRUE;
{
...
bool mu__boolexpr15;
  if (!((mu_a[mu_i]) == (mu_S))) mu__boolexpr15 = TRUE ;
  else {
...
bool mu__condition_16() // Condition for Rule "rule_4"
{
