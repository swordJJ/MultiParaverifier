/******************************
  Program "../examples/asso/n_moesi/ABS_n_moesi11.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "../examples/asso/n_moesi/ABS_n_moesi11"
...
/********************
  Invariant records
 ********************/
int mu__invariant_11() // Invariant "Moesi"
{
bool mu__quant12; 
mu__quant12 = TRUE;
{
...
for(int mu_j = 1; mu_j <= 4; mu_j++) {
bool mu__boolexpr14;
  if (!((mu_i) != (mu_j))) mu__boolexpr14 = TRUE ;
  else {
bool mu__boolexpr15;
  if (!((mu_a[mu_i]) == (mu_M))) mu__boolexpr15 = TRUE ;
  else {
...
bool mu__condition_16() // Condition for Rule "Moesi"
{
