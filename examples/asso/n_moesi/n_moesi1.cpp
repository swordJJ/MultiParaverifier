/******************************
  Program "../examples/asso/n_moesi/n_moesi1.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "../examples/asso/n_moesi/n_moesi1"
...
/********************
  Invariant records
 ********************/
int mu__invariant_1() // Invariant "Moesi"
{
bool mu__quant2; 
mu__quant2 = TRUE;
{
...
bool mu__boolexpr5;
  if (!((mu_a[mu_i]) == (mu_M))) mu__boolexpr5 = TRUE ;
  else {
  mu__boolexpr5 = ((mu_a[mu_j]) != (mu_M)) ; 
}
...
bool mu__condition_6() // Condition for Rule "Moesi"
{
