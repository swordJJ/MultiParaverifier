/******************************
  Program "../examples/asso/n_moesi/n_moesi10.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "../examples/asso/n_moesi/n_moesi10"
...
/********************
  Invariant records
 ********************/
int mu__invariant_1() // Invariant "rule_8"
{
bool mu__quant2; 
mu__quant2 = TRUE;
{
...
bool mu__boolexpr5;
  if (!((mu_a[mu_P1]) == (mu_S))) mu__boolexpr5 = TRUE ;
  else {
