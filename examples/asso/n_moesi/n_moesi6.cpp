/******************************
  Program "../examples/asso/n_moesi/n_moesi6.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "../examples/asso/n_moesi/n_moesi6"
...
/********************
  Invariant records
 ********************/
int mu__invariant_1() // Invariant "rule_5"
{
bool mu__quant2; 
mu__quant2 = TRUE;
{
...
bool mu__boolexpr5;
  if (!((mu_a[mu_P1]) == (mu_OSTATUS))) mu__boolexpr5 = TRUE ;
  else {
  mu__boolexpr5 = ((mu_a[mu_P2]) != (mu_OSTATUS)) ; 
}
