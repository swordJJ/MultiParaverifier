/******************************
  Program "../examples/asso/n_mutualEx/ABS_n_mutualEx12.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "../examples/asso/n_mutualEx/ABS_n_mutualEx12"
...
/********************
  Invariant records
 ********************/
int mu__invariant_9() // Invariant "rule_3"
{
bool mu__quant10; 
mu__quant10 = TRUE;
{
...
for(int mu_i = 1; mu_i <= 4; mu_i++) {
bool mu__boolexpr12;
  if (!((mu_j) != (mu_i))) mu__boolexpr12 = TRUE ;
  else {
bool mu__boolexpr13;
...
bool mu__condition_14() // Condition for Rule "rule_3"
{
...
int mu__invariant_15() // Invariant "mutualEx"
{
bool mu__quant16; 
mu__quant16 = TRUE;
{
...
for(int mu_j = 1; mu_j <= 4; mu_j++) {
bool mu__boolexpr18;
  if (!((mu_i) != (mu_j))) mu__boolexpr18 = TRUE ;
  else {
bool mu__boolexpr19;
  if (!((mu_n[mu_i]) == (mu_C))) mu__boolexpr19 = TRUE ;
  else {
  mu__boolexpr19 = ((mu_n[mu_j]) != (mu_C)) ; 
}
...
bool mu__condition_20() // Condition for Rule "mutualEx"
{
...
{"mutualEx", &mu__condition_20, NULL, },
{"rule_3", &mu__condition_14, NULL, },
};
