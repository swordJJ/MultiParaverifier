/******************************
  Program "../examples/asso/n_mutualEx/ABS_n_mutualEx4.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "../examples/asso/n_mutualEx/ABS_n_mutualEx4"
...
public:
  ...
  {
bool mu__boolexpr1;
  if (!((mu_x) == (mu_false))) mu__boolexpr1 = FALSE ;
  else {
bool mu__quant2; 
mu__quant2 = TRUE;
{
...
bool mu__boolexpr3;
  if (!((mu_n[mu_j]) != (mu_C))) mu__boolexpr3 = FALSE ;
  else {
  mu__boolexpr3 = ((mu_n[mu_j]) != (mu_E)) ; 
}
if ( !(mu__boolexpr3) )
  { mu__quant2 = FALSE; break; }
};
};
  mu__boolexpr1 = (mu__quant2) ; 
}
  ...
  void NextRule(unsigned & what_rule)
  {
	...
	if ( ( TRUE  ) ) {
bool mu__boolexpr4;
  if (!((mu_x) == (mu_false))) mu__boolexpr4 = FALSE ;
  else {
bool mu__quant5; 
mu__quant5 = TRUE;
{
for(int mu_j = 1; mu_j <= 4; mu_j++) {
bool mu__boolexpr6;
  if (!((mu_n[mu_j]) != (mu_C))) mu__boolexpr6 = FALSE ;
  else {
  mu__boolexpr6 = ((mu_n[mu_j]) != (mu_E)) ; 
}
if ( !(mu__boolexpr6) )
...
public:
  ...
  bool Condition(unsigned r)
  {
    ...
    r = r / 4;
bool mu__boolexpr7;
  if (!((mu_n[mu_i]) == (mu_T))) mu__boolexpr7 = FALSE ;
  else {
  ...
  void NextRule(unsigned & what_rule)
  {
	...
	if ( ( TRUE  ) ) {
bool mu__boolexpr8;
  if (!((mu_n[mu_i]) == (mu_T))) mu__boolexpr8 = FALSE ;
  else {
  mu__boolexpr8 = ((mu_x) == (mu_true)) ; 
}
	      if (mu__boolexpr8) {
		if ( ( TRUE  ) )
		  return;
...
void SetNextEnabledRule(unsigned & what_rule)
{
  ...
  if (what_rule>=6 && what_rule<10)
    { R3.NextRule(what_rule);
      if (what_rule<10) return; }
  if (what_rule>=10 && what_rule<14)
...
bool Condition(unsigned r)
{
  ...
  if (r>=6 && r<=9) return R3.Condition(r-6);
  if (r>=10 && r<=13) return R4.Condition(r-10);
...
void Code(unsigned r)
{
  ...
  if (r>=6 && r<=9) { R3.Code(r-6); return; } 
  if (r>=10 && r<=13) { R4.Code(r-10); return; } 
...
int Priority(unsigned short r)
{
  ...
  if (r>=6 && r<=9) { return R3.Priority(); } 
  if (r>=10 && r<=13) { return R4.Priority(); } 
...
char * Name(unsigned r)
{
  ...
  if (r>=6 && r<=9) return R3.Name(r-6);
  if (r>=10 && r<=13) return R4.Name(r-10);
...
/********************
  Invariant records
 ********************/
int mu__invariant_9() // Invariant "rule_1"
{
bool mu__quant10; 
mu__quant10 = TRUE;
{
for(int mu_i = 1; mu_i <= 4; mu_i++) {
bool mu__boolexpr11;
  if (!((mu_n[mu_i]) == (mu_E))) mu__boolexpr11 = TRUE ;
  else {
  mu__boolexpr11 = ((mu_x) == (mu_false)) ; 
}
if ( !(mu__boolexpr11) )
...
bool mu__condition_12() // Condition for Rule "rule_1"
{
...
int mu__invariant_13() // Invariant "mutualEx"
{
bool mu__quant14; 
mu__quant14 = TRUE;
{
...
for(int mu_j = 1; mu_j <= 4; mu_j++) {
bool mu__boolexpr16;
  if (!((mu_i) != (mu_j))) mu__boolexpr16 = TRUE ;
  else {
bool mu__boolexpr17;
  if (!((mu_n[mu_i]) == (mu_C))) mu__boolexpr17 = TRUE ;
  else {
  mu__boolexpr17 = ((mu_n[mu_j]) != (mu_C)) ; 
}
...
bool mu__condition_18() // Condition for Rule "mutualEx"
{
...
{"mutualEx", &mu__condition_18, NULL, },
{"rule_1", &mu__condition_12, NULL, },
};
