/******************************
  Program "../examples/asso/n_mutualEx/ABS_n_mutualEx9.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "../examples/asso/n_mutualEx/ABS_n_mutualEx9"
