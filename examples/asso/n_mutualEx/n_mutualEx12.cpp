/******************************
  Program "../examples/asso/n_mutualEx/n_mutualEx12.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "../examples/asso/n_mutualEx/n_mutualEx12"
...
/********************
  Invariant records
 ********************/
int mu__invariant_3() // Invariant "rule_10"
{
bool mu__quant4; 
mu__quant4 = TRUE;
{
...
bool mu__condition_6() // Condition for Rule "rule_10"
{
