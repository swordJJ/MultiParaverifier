...
and apply_form f ~p =
  ...
  | ForallFormula(pds,form) -> ForallFormula (pds, apply_form form ~p)
  | ExistFormula(pds,form) -> ExistFormula (pds,apply_form form ~p)
...
module VarNames = struct
  ...
  and of_form f =
    ...
    | ForallFormula(pds,form) -> of_form form
    |ExistFormula(pds,form) -> of_form form 
...
module VarNamesWithParam = struct
  ...
  and of_form ~of_var f =
    ...
    | ForallFormula(pds,form) -> of_form ~of_var form 
    | ExistFormula(pds,form) -> of_form ~of_var form
