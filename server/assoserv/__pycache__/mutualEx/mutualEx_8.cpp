/******************************
  Program "mutualEx/mutualEx_8.m" compiled by "Caching Murphi Release 5.4.9.1"
...
#define PROTOCOL_NAME "mutualEx/mutualEx_8"
...
/********************
  Invariant records
 ********************/
int mu__invariant_3() // Invariant "rule_6"
{
bool mu__quant4; 
mu__quant4 = TRUE;
{
...
bool mu__boolexpr5;
  if (!((mu_n[mu_P1]) == (mu_C))) mu__boolexpr5 = TRUE ;
  else {
...
bool mu__condition_6() // Condition for Rule "rule_6"
{
